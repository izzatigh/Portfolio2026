    ...
    <section className="py-section">
      <Container>
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="card-futuristic rounded-card border border-border bg-surface p-8 shadow-card">
          ...
          <div className="card-futuristic rounded-card border border-accent/15 bg-accent/5 p-8">
